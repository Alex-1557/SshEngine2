...
Namespace Services
    ...
    'encrypted/decrypted password and key can less than 15 chars
    Public Class AesCryptor
        ...
        Public Function DecryptSqlConnection(CN As String, MySQLMaskedPass As String) As String Implements IAesCryptor.DecryptSqlConnection
            Dim Dercryptor As New AesCryptor
            Dim Bytes = System.Convert.FromBase64String(MySQLMaskedPass)
